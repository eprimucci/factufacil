<div class="invoices index">
	...
	<tr>
		...
		<td><?php echo h($invoice['Invoice']['issued_date']); ?>&nbsp;</td>
		<td><?php echo h($invoice['Invoice']['number']); ?>&nbsp;</td>
		<td><?php echo h($invoice['Invoice']['period']); ?>&nbsp;</td>
		<td><?php echo h($invoice['Invoice']['paid']); ?>&nbsp;</td>
		<td><?php echo h($invoice['Invoice']['paid_date']); ?>&nbsp;</td>
		<td>
